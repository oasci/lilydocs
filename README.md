...
[Lily Docs](https://lotusdocs.dev) is an easily updated and customizable [Hugo](https://gohugo.io/) theme for building fast, secure, and SEO-friendly documentation sites.

![Lily Docs Banner](https://res.cloudinary.com/lotuslabs/image/upload/r_10/v1693340386/Lotus%20Docs/Social%20Media/lotus_docs_social_preview_github_1280x640_colour_v1.3_xzm1ex.webp)

Check out the demo site [https://lotusdocs.dev/docs/](https://lotusdocs.dev/docs/) (also doubles as the documentation guide for Lily Docs 📖)
...
The Lily Docs theme makes use of the [Hugo Bootstrap Module](https://github.com/gohugoio/hugo-mod-bootstrap-scss). For this reason, it's necessary to initialize your site as a Hugo Module. If your site isn't already, use the `hugo mod init` command to initialize your site as a Hugo module:
...
Edit the `hugo.toml` configuration file to include the [Lily Docs theme](https://github.com/oasci/lotusdocs) and the [Hugo Bootstrap module](https://github.com/gohugoio/hugo-mod-bootstrap-scss) as modules:
...
[module]
    ...
    replacements = "github.com/oasci/lotusdocs -> lotusdocs"
    [[module.imports]]
        path = "github.com/oasci/lotusdocs"
        disable = false
    [[module.imports]]
...
There may be cases where you prefer to customize and maintain the Lily Docs theme yourself. In such cases, use `git` to clone the theme into the `themes/lotusdocs` directory:
